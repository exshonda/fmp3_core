 ...
 *  の責任を負わない．
 * 
 *  $Id: simt_systim1_64hrt.c 1214 2026-05-26 08:18:29Z ertl-hiro $
 */
 ...
 *	88:	adj_tim(-200)					... (A-3)	// ALM1の発生：4,000,001,511
 *	89:		[hook_hrt_set_event <- 4000000201U]
 *	90:	slp_tsk()
 *	== HRT_HANDLER									// 時刻：4,000,001,511
 *	== ALM1-8（8回目）==
 *	91:	assert(fch_hrt() == 4000001521U)			// 時刻：4,000,001,521
 *	92:	wup_tsk(TASK1)
 *		RETURN
 *	93:		[hook_hrt_clear_event]
 *	== TASK1（続き）==
 *	94:	END
 */
